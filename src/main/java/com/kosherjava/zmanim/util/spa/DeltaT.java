...
import static com.kosherjava.zmanim.util.spa.MathUtil.polynomial;

/**
 * Estimate values for Delta T, the difference between Terrestrial Time (TT) and Universal Time (UT1).
 */
